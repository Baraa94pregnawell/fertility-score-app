...
export const QUESTIONS: Question[] = [
  ...
  { id: 'q4', sectionId: 2, type: 'multi', required: true,
    ...
    options: [
      ...
      { value: 'lowcarb', label: 'Low carb — تقليل النشويات (الكربوهيدرات)' },
  ...
  { id: 'q5', sectionId: 2, type: 'single', required: true,
    text: 'هل تقللين النشويات (الكربوهيدرات) بشكل مستمر الآن؟',
    options: [
      { value: 'always', label: 'نعم، أتجنب النشويات (الكربوهيدرات) دائماً' },
      { value: 'sometimes', label: 'أحياناً أقللها' },
      { value: 'no', label: 'لا، آكل النشويات (الكربوهيدرات) بشكل طبيعي' },
      { value: 'dontknow', label: 'ما أعرف ماهي النشويات (الكربوهيدرات) بالضبط' },
    ],
  },
